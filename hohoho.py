...
def safe_array(*args, **kwargs):
    # Tangani hanya kalau copy=False
    if kwargs.get("copy", False) is False:
        kwargs["copy"] = True
    # Panggil fungsi asli supaya keyword seperti subok/order diterima
    return _original_array(*args, **kwargs)

# Ganti np.array dengan versi aman
np.array = safe_array
...
class StockAnalyzer:
    ...
    # Train new model
        ...
        try:
            ...
            y = np.asarray([label_map[label] for label in y])
