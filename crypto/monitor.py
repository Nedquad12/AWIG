...
class PositionMonitor:
    ...
    async def _close_position(
        ...
        if "TP tercapai" in reason or "Trailing SL" in reason:
            close_status = "TP"
        else:
            close_status = "SL"

        # Ban logic:
        # Ban  → SL murni dan volume reversal
        # Skip → Trailing SL (posisi sempat profit) dan TP
        should_ban = close_status == "SL"
        if should_ban:
            try:
                register_sl(symbol)
